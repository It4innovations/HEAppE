...
namespace HEAppE.DataAccessTier.Migrations
{
    ...
    [Migration("20260528134751_SubmittedJobInfoIdIndex")]
    partial class SubmittedJobInfoIdIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HEAppE.DomainObjects.JobManagement.ClusterProject", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ClusterId"), new[] { "ProjectId", "PreferredAuthType" });

                    b.HasIndex("ProjectId")
                        .HasFilter("[IsDeleted] = 0");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ProjectId"), new[] { "ClusterId", "PreferredAuthType" });
            ...
            modelBuilder.Entity("HEAppE.DomainObjects.JobManagement.JobInformation.SubmittedTaskInfo", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("State"), new[] { "ProjectId", "SpecificationId", "SubmittedJobInfoId", "NodeTypeId" });

                    b.HasIndex("SubmittedJobInfoId");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("SubmittedJobInfoId"), new[] { "State", "SpecificationId", "NodeTypeId", "ProjectId" });
