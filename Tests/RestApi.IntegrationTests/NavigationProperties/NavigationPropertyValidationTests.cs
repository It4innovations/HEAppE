...
namespace HEAppE.RestApi.IntegrationTests.NavigationProperties
{
    ...
    public class NavigationPropertyValidationTests : ManagementTestBase
    {
        ...
        [Fact]
        public async Task ListAvailableProjects_ShouldLoadNavigationProperties()
        {
            var sessionCode = await GetAdminSessionCodeAsync();
            var url = $"/heappe/ClusterInformation/ListAvailableProjects?sessionCode={sessionCode}";
            
            var projects = await _client.GetJsonAsync<IEnumerable<ProjectExt>>(url);
        ...
        [Fact]
        public async Task ListAvailableClusterNodeTypes_ShouldLoadNavigationProperties()
        {
            var sessionCode = await GetAdminSessionCodeAsync();
            var url = $"/heappe/ClusterInformation/ListAvailableClusterNodeTypes?sessionCode={sessionCode}";
            
            var nodeTypes = await _client.GetJsonAsync<IEnumerable<ClusterNodeTypeExt>>(url);
        ...
        [Fact]
        public async Task ListJobsForCurrentUser_ShouldLoadNavigationProperties()
        {
            var sessionCode = await GetAdminSessionCodeAsync();
            var url = $"/heappe/JobManagement/ListJobsForCurrentUser?sessionCode={sessionCode}";
        ...
        [Fact]
        public async Task ListSubmittedJobInfo_ShouldLoadNavigationProperties()
        {
            var sessionCode = await GetAdminSessionCodeAsync();
            var url = $"/heappe/JobReporting/ListSubmittedJobInfo?sessionCode={sessionCode}";
        ...
        [Fact]
        public async Task GetCredentials_ShouldLoadNavigationProperties()
        {
            var sessionCode = await GetAdminSessionCodeAsync();
            var url = $"/heappe/Credentials/GetCredentials?projectId=1&sessionCode={sessionCode}";
