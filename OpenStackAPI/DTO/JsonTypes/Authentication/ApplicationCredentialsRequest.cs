...
namespace HEAppE.OpenStackAPI.DTO.JsonTypes.Authentication
{
    public class ApplicationCredentialsRequest
    {
        ...
        #endregion
        #region Methods
        public static ApplicationCredentialsRequest CreateApplicationCredentialsRequest(string uniqueName, DateTime expiration, bool restricted = true, IEnumerable<Role> roles = null, IEnumerable<AccessRule> accessRules = null)
        {
