...
public class AuthenticatedUserAlreadyDeletedException : ExternalException
{
    ...
    public AuthenticatedUserAlreadyDeletedException(string message, Exception innerException, params object[] args) :
        base(message, innerException, args)
    {
    }

    public AuthenticatedUserAlreadyDeletedException(string message, Exception innerException) : base(message,
        innerException)
    {
    }
}