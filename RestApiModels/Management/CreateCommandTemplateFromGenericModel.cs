...
public class CreateCommandTemplateFromGenericModel : SessionCodeModel
{
    ...
    {
        return
            $"CreateCommandTemplateFromGenericModel({base.ToString()}; GenericCommandTemplateId: {GenericCommandTemplateId}; Name: {Name}; Description: {Description}; ExtendedAllocationCommand: {ExtendedAllocationCommand}; ExecutableFile: {ExecutableFile}; PreparationScript: {PreparationScript})";
    }
}