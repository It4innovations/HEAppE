...
namespace Kerberos.NET.Client
{
    internal class TcpSocket : ITcpSocket
    {
        ...
        /// <summary>
        /// Get the actual state of the TCP socket.
        /// Fix provided by https://stackoverflow.com/a/44242399
        /// </summary>
        public TcpState GetTcpClientState()
        {
            var tcpInfo = IPGlobalProperties.GetIPGlobalProperties()
                                            .GetActiveTcpConnections()
                                            .SingleOrDefault(x => x.LocalEndPoint.Equals(this.client.Client.LocalEndPoint) &&
                                                             x.RemoteEndPoint.Equals(this.client.Client.RemoteEndPoint)
            );

            return tcpInfo != null ? tcpInfo.State : TcpState.Unknown;
        }
