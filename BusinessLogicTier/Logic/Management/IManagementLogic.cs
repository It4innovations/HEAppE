...
namespace HEAppE.BusinessLogicTier.Logic.Management
{
    public interface IManagementLogic
    {
        ...
        SecureShellKey CreateSecureShellKey(string username, long projectId);
        SecureShellKey RecreateSecureShellKey(string username, string publicKey, long projectId);
