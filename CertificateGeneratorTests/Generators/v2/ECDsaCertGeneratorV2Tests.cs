...
public class ECDsaCertGeneratorV2Tests
{
    private readonly ECDsaCertGeneratorV2 _generator;
    private readonly int _keySize = 521;

    public ECDsaCertGeneratorV2Tests()
    {
        _generator = new ECDsaCertGeneratorV2(_keySize);
    }
    ...
    public void ToPublicKeyInAuthorizedKeysFormat_Should_Return_PublicKey_With_No_Comment()
    {
        ...
        Assert.StartsWith($"ecdsa-sha2-nistp{_keySize}", publicKey);
    }
    ...
    public void ToPublicKeyInAuthorizedKeysFormatFromPrivateKey__Should_Return_PublicKey_With_No_Comment()
    {
        ...
        // Act
        var publicKey = ECDsaCertGeneratorV2.ToPublicKeyInAuthorizedKeysFormatFromPrivateKey(encryptedKey, password);
    ...
    public void ToPublicKeyInAuthorizedKeysFormatFromPrivateKey__Should_Return_PublicKey_With_Comment()
    {
        ...
        // Act
        var publicKey = ECDsaCertGeneratorV2.ToPublicKeyInAuthorizedKeysFormatFromPrivateKey(encryptedKey, password, comment);
    ...
    public void ToPublicKeyInPEMFromPrivateKey_Should_Return_PublicKey()
    {
        ...
        // Act
        var publicKey = ECDsaCertGeneratorV2.ToPublicKeyInPEMFromPrivateKey(encryptedKey, password);
