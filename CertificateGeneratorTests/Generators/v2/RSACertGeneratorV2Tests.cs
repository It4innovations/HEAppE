...
public class RSACertGeneratorV2Tests
{
    private readonly RSACertGeneratorV2 _generator;

    public RSACertGeneratorV2Tests()
    {
        _generator = new RSACertGeneratorV2();
    }
    ...
    public void ToEncryptedPrivateKeyInPEM_Should_Return_EncryptedPrivateKey_In_PEM_Format()
    {
        ...
        Assert.StartsWith("-----BEGIN RSA PRIVATE KEY-----", encryptedKey);
    ...
    public void ToPublicKeyInAuthorizedKeysFormatFromPrivateKey__Should_Return_PublicKey_With_No_Comment()
    {
        ...
        // Act
        var publicKey = RSACertGeneratorV2.ToPublicKeyInAuthorizedKeysFormatFromPrivateKey(encryptedKey, password);
    ...
    public void ToPublicKeyInAuthorizedKeysFormatFromPrivateKey__Should_Return_PublicKey_With_Comment()
    {
        ...
        // Act
        var publicKey = RSACertGeneratorV2.ToPublicKeyInAuthorizedKeysFormatFromPrivateKey(encryptedKey, password, comment);
