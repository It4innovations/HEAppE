...
public static class ResourceAccountingUtils
{
    ...
    public static void ComputeAccounting(SubmittedTaskInfo dbTaskInfo, SubmittedTaskInfo submittedTaskInfo, ILogger logger, Func<long, ResourceConsumed> getExistingResourceConsumed = null)
    {
