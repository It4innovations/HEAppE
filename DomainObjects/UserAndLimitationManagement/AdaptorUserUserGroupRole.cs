...
public class AdaptorUserUserGroupRole : ISoftDeletableEntity
{
    ...
    {
        return
            $"AdaptorUserUserGroupRole: AdaptorUser={AdaptorUser}, AdaptorUserGroup={AdaptorUserGroup}, AdaptorUserRole={AdaptorUserRole}, CreatedAt={CreatedAt}, ModifiedAt={ModifiedAt}, IsDeleted={IsDeleted}";
    }
}