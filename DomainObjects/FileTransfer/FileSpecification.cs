...
{
    [Required] [StringLength(50)] public string RelativePath { get; set; }
    ...
    public override string ToString()
    {
        return string.Format(
            "FileSpecification: Id={0}, RelativePath={1}, NameSpecification={2}, SynchronizationType={3}", Id,
            RelativePath, NameSpecification,
            SynchronizationType);
    }
}