...
namespace HEAppE.RestApi.Configuration
{
    ...
    public sealed class DeploymentInformationsConfiguration
    {
        ...
        /// Deployment type
        /// </summary>
        private static DeploymentType _deploymentType = DomainObjects.Management.DeploymentType.Unspecific;

        /// <summary>
        /// Resource allocation types
        /// </summary>
        private static ResourceAllocationType[] _resourceAllocationTypes = new ResourceAllocationType[1] { ResourceAllocationType.None };
        #endregion
        #region Properties
        /// <summary>
        /// Instance name
        ...
        public static string DeploymentEnvironmentType
        {
            ...
            set
            {
                _deploymentType = Enum.TryParse(value, true, out DeploymentType convert)
                                        ? convert
                                        : DomainObjects.Management.DeploymentType.Unspecific;
            }
        }
            ...
            set
            {
                if (value.Length > 0)
                {
                    ...
                    foreach (var allocationType in value)
                    {
                        ...
                        {
                            _resourceAllocationTypes = new ResourceAllocationType[] { ResourceAllocationType.None };
                            break;
                        }
                    }
                    _resourceAllocationTypes = value.Length == allocationTypes.Count
                                                    ? allocationTypes.ToArray()
                                                    : new ResourceAllocationType[] { ResourceAllocationType.None };
                }
                else
                {
                    _resourceAllocationTypes = new ResourceAllocationType[] { ResourceAllocationType.None };
        ...
        /// Resource allocation types
        /// </summary>
        public static ResourceAllocationType[] ResourceAllocationTypes
        {
            get => _resourceAllocationTypes;
        }
        #endregion
    }
}
