...
public class OpenIdUserAuthenticationResult
{
    ...
    /// <summary>
    ///     Optional refresh token, which can be used to obtain new access tokens. Issued only for long-lived authorisations
    ///     that permit it.
    /// </summary>
    ...
    /// <summary>
    ///     Represents the End-User's login state at the OP. It MUST NOT contain the space (" ") character. This value is
    ///     opaque to the RP. This is REQUIRED if session management is supported.
    /// </summary>
