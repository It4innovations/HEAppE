...
public class RexSchedulerWrapper : IRexScheduler
{
    ...
    public (bool,string) TestClusterAccessForAccount(Cluster cluster, ClusterAuthenticationCredentials clusterAuthCredentials, string sshCaToken, string lexisToken)
    {
        try
        {
