...
internal enum SlurmTaskState
{
    ...
    /// <summary>
    ///     The job was requeued in a special state. This state can be set by users, typically in EpilogSlurmctld, if the job
    ///     has terminated with a particular exit value.
    /// </summary>
    SpecialExit = 20,
