...
public class TaskDetailedReportExt
{
    ...
    [DataMember] public string ScheduledJobId { get; set; }

    [DataMember] public string Name { get; set; }

    [DataMember] public TaskStateExt State { get; set; }

    [DataMember] public DateTime? StartTime { get; set; }

    [DataMember] public DateTime? EndTime { get; set; }

    [DataMember] public long CommandTemplateId { get; set; }

    [DataMember] public string CommandTemplateName { get; set; }
