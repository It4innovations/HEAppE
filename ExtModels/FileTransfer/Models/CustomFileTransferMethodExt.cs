...
{
    [DataContract(Name = "CustomFileTransferMethodExt")]
    public class CustomFileTransferMethodExt
    {
        ...
        public CustomFileTransferKeyCredentialsExt Credentials { get; set; }

        public override string ToString()
        {
            return $"""FileTransferMethodExt: ServerHostname="{ServerHostname}", SharedBasepath="{SharedBasepath}", Protocol="{Protocol}", ProxyConnection="{ProxyConnection}, Credentials="{Credentials}"")""";
        }
    }
}
