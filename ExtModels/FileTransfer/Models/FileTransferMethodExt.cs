...
public class FileTransferMethodExt
{
    ...
    [DataMember(Name = "ServerHostname")] public string ServerHostname { get; set; }

    [DataMember(Name = "SharedBasepath")]
    [StringLength(200)]
    public string SharedBasepath { get; set; }

    [DataMember(Name = "Protocol")] public FileTransferProtocolExt? Protocol { get; set; }
    ...
    [DataMember(Name = "Credentials")] public FileTransferKeyCredentialsExt Credentials { get; set; }
