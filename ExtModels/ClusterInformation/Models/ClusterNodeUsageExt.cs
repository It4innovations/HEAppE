...
public class ClusterNodeUsageExt
{
    ...
    [DataMember(Name = "TotalJobs")] public int? TotalJobs { get; set; }

    public override string ToString()
    {
        return
            $"ClusterNodeUsageExt(id={Id}; name={Name}; description={Description}; priority={Priority}; coresPerNode={CoresPerNode}; maxWallTime={MaxWalltime}; numberOfNodes={NumberOfNodes}; numberOfUsedNodes={NumberOfUsedNodes}; totalJobs={TotalJobs})";
    }
}