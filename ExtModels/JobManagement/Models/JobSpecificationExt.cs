...
public class JobSpecificationExt
{
    ...
    [DataMember(Name = "WaitingLimit")] public int? WaitingLimit { get; set; }

    [DataMember(Name = "WalltimeLimit")] public int? WalltimeLimit { get; }
    ...
    [DataMember(Name = "NotifyOnAbort")] public bool? NotifyOnAbort { get; set; }

    [DataMember(Name = "NotifyOnFinish")] public bool? NotifyOnFinish { get; set; }

    [DataMember(Name = "NotifyOnStart")] public bool? NotifyOnStart { get; set; }
    ...
    [DataMember(Name = "IsExtraLong")] public bool IsExtraLong { get; set; }

    [DataMember(Name = "EnvironmentVariables")]
    public EnvironmentVariableExt[] EnvironmentVariables { get; set; }

    [DataMember(Name = "Tasks")] public TaskSpecificationExt[] Tasks { get; set; }
