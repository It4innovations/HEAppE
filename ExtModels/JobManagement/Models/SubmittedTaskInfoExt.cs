...
public class SubmittedTaskInfoExt
{
    ...
    [DataMember(Name = "State")] public TaskStateExt? State { get; set; }

    [DataMember(Name = "Priority")] public TaskPriorityExt? Priority { get; set; }

    [DataMember(Name = "AllocatedTime")] public double? AllocatedTime { get; set; }
    ...
    [DataMember(Name = "NodeType")] public ClusterNodeTypeForTaskExt NodeType { get; set; }
    ...
    {
        return
            $"SubmittedTaskInfoExt(id={Id}; name={Name}; state={State}; priority={Priority}; allocatedTime={AllocatedTime}; allocatedCoreIds={AllocatedCoreIds}; startTime={StartTime}; endTime={EndTime}; nodeType={NodeType}; errorMessage={ErrorMessage})";
    }
}