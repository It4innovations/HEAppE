...
{
    /// <summary>
    ///     Tries to deserialize the REST response content to given type. If deserialization or request fails the exception is
    ///     thrown.
    /// </summary>
    ...
    public static TParseResult ParseJsonOrThrow<TParseResult, TExceptionType>(RestResponse response,
